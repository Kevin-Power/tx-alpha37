...
- 結構37（再加「昨收在 20 日均之上」）：**不是升級**。H-04 沒加分，H-05／H-07 殺掉避震器與跨星期結構故事
...
**假 edge 殺得差不多了，策略還沒成形。** H-04 之後缺口放假通過失敗、結構37 沒加分。H-05 殺掉「靠三個大虧月避震」；H-07 殺掉「MA20 是跨星期結構」。加權路徑上唯一種子穩健的結論仍是負結論：無濾網 TORB 扣完成本後沒有 edge。下表的正 PF 是 seed 0 加權數字，只能當上界。這不是投資建議。
...
```
RESEARCH.md          完整方法、結果、限制、文獻（§5.6 H-06，§5.7 H-11，§5.8 H-04，§5.9 H-05，§5.10 H-07）
