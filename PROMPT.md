...
- 無濾網 TORB 扣成本後 PF 0.99，已經死了——但不乾淨，停損 0.7 vs 0.55。**不要把 ALPHA-37 PF 1.15 寫成薄 edge。** 2025 PF 0.99 是否決票。OOS PF 1.19 把整段 2026 灌進樣本外。週五拿走七成淨利；週五 2025 OOS 段 PF 0.84。結構37 不是升級（TX 上沒加分；H-05 避震器殺掉；H-07 跨星期結構殺掉）。H-06：≥ 0.8 ATR 放假只在加權假開盤上有條件通過，H-04 換成 TX 真開盤後通過失敗；0.55 順勢不列升級。H-11：ATR 擴張 2.0 複製不了結構37（0 日開火）。跳過月結算、外資水位濾網已經被推翻。
