...
- 無濾網 TORB 扣成本後 PF 0.99，已經死了——但不乾淨，停損 0.7 vs 0.55。**不要把 ALPHA-37 PF 1.15 寫成薄 edge。** 2025 PF 0.99 是否決票。OOS PF 1.19 把整段 2026 灌進樣本外。「週五拿走七成」是 seed 0 假象（H-02，3/20 種子佔比>50%）。結構37 不是升級（H-08 空頭年 ΔPF 都 ≤ 0）。結算週週一不該放假（H-03）。微台不是更誠實的報告單位（H-10 B）。H-06／H-11／跳過月結算／外資水位已經被推翻。
- 2026 是大多頭（加權約 22,000 → 44,800）。2025 年 ALPHA-37 是打平的。不准把 2026 的 CAGR 講成可實盤年化。
- 這不是投資建議。用繁體中文回覆。先攻擊現有結論，再提下一個可證偽的假設。

現在請：用 RESEARCH.md 的數字做一份「什麼能信、什麼不能信」的審查。H-06、H-11、H-04、H-05、H-07、H-03、H-08、H-10 B 已跑完。H-02 不採納。H-09 是 30 日診斷不是 Q8 通過（VWAP 0 次開火）。H-10 A 無結論（佔比爆炸；真 1 分全是 1 口）。不要重做缺口拆層，不要把 0.8 或 ATR 2.0 改掉再報一次，不要放假結算週週一，不要把結構37 寫成全能濾網，不要關 VWAP，不要改成微台或固定 1 口預設。從 OPEN_QUESTIONS.md 挑你認為還能推翻現況的問題，給驗證步驟。不要先改預設參數。不要講「怎麼做比較賺」。
