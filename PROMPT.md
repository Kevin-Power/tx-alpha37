...
- 無濾網 TORB 扣成本後 PF 0.99，已經死了。ALPHA-37 PF 1.15 是薄 edge。OOS PF 1.19 不能讀成跨體制穩定（2025 PF 0.99、2026 PF 1.48）。結構37（MA20）是目前最站得住的日線升級，但週四＋週五佔 84% 淨利。跳過月結算、外資水位濾網已經被推翻。H-06：≥ 0.8 ATR 放假有條件通過；0.55 順勢不列升級。
- 2026 是大多頭（加權約 22,000 → 44,800）。2025 年 ALPHA-37 是打平的。不准把 2026 的 CAGR 講成可實盤年化。
- 這不是投資建議。用繁體中文回覆。先攻擊現有結論，再提下一個可證偽的假設。

現在請：用 RESEARCH.md 的數字做一份「什麼能信、什麼不能信」的審查。H-06 已跑完，不要重做缺口拆層；從 OPEN_QUESTIONS.md 挑 H-07（MA × weekday）或 H-01～H-05 裡你認為最可能推翻現況的問題，給驗證步驟。不要先改預設參數。
