...
現在請：用 RESEARCH.md 的數字做一份「什麼能信、什麼不能信」的審查。H-06、H-11、H-04、H-05、H-07、H-03、H-08 已跑完。H-02 不採納。H-09 是 30 日診斷不是 Q8 通過（VWAP 0 次開火）。不要重做缺口拆層，不要把 0.8 或 ATR 2.0 改掉再報一次，不要放假結算週週一，不要把結構37 寫成全能濾網，不要關 VWAP。從 OPEN_QUESTIONS.md 挑你認為還能推翻現況的問題，給驗證步驟。不要先改預設參數。不要講「怎麼做比較賺」。
